    ...
    <Fragment>
                <div className="col-12">
                    <div className="my_appointment_view_all_appointment_container">
                            <div className="my_appointment_view_all_appointment">
                                    <div onClick={()=>{
                                    ...
                                    <div>
                                        <span>
                                            ...
                                            <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
                                                <MenuItem onClick={()=>{
                                                    setState(true)
                                                }} className="view_more">Cancel Event</MenuItem>
                                                <MenuItem onClick={()=>{
                                                    Router.push("/reschedule-appointment/event_slug")
                                                }} className="view_more">Rescheduled Event</MenuItem>
                                            </Menu>
                                        </span>
                                    </div>
                            </div>
                    ...
                    <div className="my_appointment_view_all_appointment_container">
                            <div className="my_appointment_view_all_appointment">
                                    ...
                                    <div onClick={()=>{
                                        ...
                                        <p className="my_appointment_event_type">
                                            <span>
                                                <IoVideocamOutline className="margin-top-negetive-2"/> Video call | <IoMdTime className="margin-top-negetive-2" /> 30 Minutes
                                            </span>
                                        </p>
                                    </div>
                                    <div className="" onClick={()=>{
                                        ...
                                        <hr className="dashed_seperator_line"/>
                                        <span className="appointment_price">
                                            <IoVideocamOutline className="my_appointment_event_icon"/>
                                        </span>
                                    </div>
                    ...
                    <div className="my_appointment_view_all_appointment_container">
                            <div className="my_appointment_view_all_appointment">
                                    ...
                                    <div onClick={()=>{
                                        ...
                                        <p className="my_appointment_event_type">
                                            <span>
                                                <AiOutlineMessage className="margin-top-negetive-2"/> Message | <IoMdTime className="margin-top-negetive-2" /> 30 Minutes
                                            </span>
                                        </p>
                                    </div>
                                    <div className="" onClick={()=>{
                                        ...
                                        <hr className="dashed_seperator_line"/>
                                        <span className="appointment_price">
                                            <AiOutlineMessage className="my_appointment_event_icon"/>
                                        </span>
                                    </div>
