           ...
           <div className="row">
              <div className="col-12">
                   <div className="d-lg-flex d-md-none d-none dashboard_main_footer_container">
                           <h5 className='footer_dashboard_copyright d-md-none d-none d-lg-block'>COPYRIGHT © {new Date().getFullYear()} Quizophy, All rights Reserved</h5>
                           <h5 className="footer_dashboard_handcrafted d-md-none d-none  d-lg-block">Hand-crafted & Made by Quizophy</h5>
                   </div>
