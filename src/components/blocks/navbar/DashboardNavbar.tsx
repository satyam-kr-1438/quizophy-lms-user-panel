  ...
  const headerContent = (
    <Fragment>
      <div className="navbar-brand w-100">
        <NextLink href="/dashboard/quizzes" title={<img alt="logo" style={{width:"130px",cursor:"pointer"}} src={`/img/${logo}.png`} />} />
      </div>

      <div id="offcanvas-nav" data-bs-scroll="true" className="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
        <div className="offcanvas-header d-lg-none">
          <h3 className="text-white fs-30 mb-0">Quizophy</h3>
        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100">
          <ul className="navbar-nav">
            <li className="nav-item dropdown dropdown-mega">
              ...
              <DashboardNavbarLink title="Free Quizzes" className="nav-link" to="/dashboard/quizzes"/>
            </li>
            <li className="nav-item dropdown dropdown-mega">
              {/* <DropdownToggleLink title="Quizzes" className="nav-link dropdown-toggle" /> */}
              <DashboardNavbarLink title="Packages" className="nav-link" to="/dashboard/packages"/>
            </li>
          ...
          <div className="offcanvas-footer d-lg-none">
            <div>
              <NextLink title="admin@quizophy.com" className="link-inverse" href="mailto:admin@quizophy.com" />
              <br />
              <NextLink href="tel:+91 9672858858" title="+91 9672858858" />
              <br />
              <SocialLinks />
            </div>
          </div>
